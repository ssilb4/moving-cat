...
var o27700 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27700["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27701 = temp__5718__auto____$1;
return (o27701["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26779__auto__ = f;
return (o__26779__auto__["toString"]).call(o__26779__auto__);
} else {
return "";
}
}catch (e27702){var _ = e27702;
return "";
}});
...
try{var o__26779__auto___27704 = t;
(o__26779__auto___27704["cljs$lang$ctorPrWriter"]).call(o__26779__auto___27704,t,writer);
}catch (e27703){var __27705 = e27703;
}
...
var char_code = (function (){var o__26779__auto__ = (new String(char$));
return (o__26779__auto__["charCodeAt"]).call(o__26779__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26779__auto__ = String;
return (o__26779__auto__["fromCharCode"]).call(o__26779__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27706 = num_code;
switch (G__27706) {
case (1):
return (185);
...
var o__26779__auto__ = String;
return (o__26779__auto__["fromCharCode"]).call(o__26779__auto__,superscript_code);
});
/**
...
}catch (e27708){var _e__26786__auto__ = e27708;
return false;
}})())){
...
var vec__27709 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27709,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27712 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27712["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27713 = temp__5718__auto____$1;
return (o27713["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___27720 = arguments.length;
var i__4642__auto___27721 = (0);
while(true){
if((i__4642__auto___27721 < len__4641__auto___27720)){
args__4647__auto__.push((arguments[i__4642__auto___27721]));

var G__27722 = (i__4642__auto___27721 + (1));
i__4642__auto___27721 = G__27722;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27716){
var vec__27717 = p__27716;
var ns_detector = cljs.core.nth.call(null,vec__27717,(0),null);
...
var G__27723 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27724 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27723;
remaining_tokens = G__27724;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27714){
var G__27715 = cljs.core.first.call(null,seq27714);
var seq27714__$1 = cljs.core.next.call(null,seq27714);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27715,seq27714__$1);
});
...
var vec__27728 = cljs.core.split_with.call(null,(function (p1__27727_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27727_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27728,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27728,(1),null);
...
var vec__27731 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27731,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27731,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27734 = cljs.core.rest.call(null,remaining_tokens);
var G__27735 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27734;
name_tokens = G__27735;
continue;
} else {
...
var vec__27738 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27738,(0),null);
var arity = cljs.core.nth.call(null,vec__27738,(1),null);
var vec__27741 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27741,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27741,(1),null);
var vec__27744 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27744,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27744,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27744,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27744,(3),null);
...
var vec__27750 = result;
var munged_ns = cljs.core.nth.call(null,vec__27750,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27750,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27750,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27750,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27750,(4),null);
var arity = cljs.core.nth.call(null,vec__27750,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27754 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__27754,(0),null);
var args = cljs.core.nth.call(null,vec__27754,(1),null);
var vec__27757 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27757,(0),null);
var name = cljs.core.nth.call(null,vec__27757,(1),null);
...
var G__27760 = (arity + (1));
var G__27761 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27762){
var vec__27763 = p__27762;
var arity = cljs.core.nth.call(null,vec__27763,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27763,(1),null);
...
return cljs.core.get.call(null,arities,p1__27766_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27767_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___27774 = arguments.length;
var i__4642__auto___27775 = (0);
while(true){
if((i__4642__auto___27775 < len__4641__auto___27774)){
args__4647__auto__.push((arguments[i__4642__auto___27775]));

var G__27776 = (i__4642__auto___27775 + (1));
i__4642__auto___27775 = G__27776;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27770){
var vec__27771 = p__27770;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27771,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27768){
var G__27769 = cljs.core.first.call(null,seq27768);
var seq27768__$1 = cljs.core.next.call(null,seq27768);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27769,seq27768__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27779__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27779__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27779__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27779__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27780 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27780,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27780,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27780,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27780,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27780,(4),null);
var arity = cljs.core.nth.call(null,vec__27780,(5),null);
...
var o__26779__auto__ = f;
return (o__26779__auto__["getBasis"]).call(o__26779__auto__);
});
/**
...
}catch (e27784){var _e__26786__auto__ = e27784;
...
var G__27785 = (obj[cljs.core.first.call(null,path)]);
var G__27786 = cljs.core.rest.call(null,path);
obj = G__27785;
path = G__27786;
continue;
} else {
...
return (function (accum,p__27787){
var vec__27788 = p__27787;
var bit = cljs.core.nth.call(null,vec__27788,(0),null);
var protocol = cljs.core.nth.call(null,vec__27788,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27791){
var vec__27792 = p__27791;
var ns = cljs.core.nth.call(null,vec__27792,(0),null);
var name = cljs.core.nth.call(null,vec__27792,(1),null);
var selector = cljs.core.nth.call(null,vec__27792,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27797,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27797,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27797,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27795_SHARP_){
return (obj[cljs.core.first.call(null,p1__27795_SHARP_)]);
});})(name,sorted_matches,vec__27797,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1547205521146
