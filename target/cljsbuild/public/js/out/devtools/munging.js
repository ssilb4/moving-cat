...
var o28942 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28942["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28943 = temp__5718__auto____$1;
return (o28943["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27872__auto__ = f;
return (o__27872__auto__["toString"]).call(o__27872__auto__);
} else {
return "";
}
}catch (e28944){var _ = e28944;
return "";
}});
...
try{var o__27872__auto___28946 = t;
(o__27872__auto___28946["cljs$lang$ctorPrWriter"]).call(o__27872__auto___28946,t,writer);
}catch (e28945){var __28947 = e28945;
}
...
var char_code = (function (){var o__27872__auto__ = (new String(char$));
return (o__27872__auto__["charCodeAt"]).call(o__27872__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27872__auto__ = String;
return (o__27872__auto__["fromCharCode"]).call(o__27872__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28948 = num_code;
switch (G__28948) {
case (1):
return (185);
...
var o__27872__auto__ = String;
return (o__27872__auto__["fromCharCode"]).call(o__27872__auto__,superscript_code);
});
/**
...
}catch (e28950){var _e__27879__auto__ = e28950;
return false;
}})())){
...
var vec__28951 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28951,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o28954 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28954["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28955 = temp__5718__auto____$1;
return (o28955["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___28962 = arguments.length;
var i__4642__auto___28963 = (0);
while(true){
if((i__4642__auto___28963 < len__4641__auto___28962)){
args__4647__auto__.push((arguments[i__4642__auto___28963]));

var G__28964 = (i__4642__auto___28963 + (1));
i__4642__auto___28963 = G__28964;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28958){
var vec__28959 = p__28958;
var ns_detector = cljs.core.nth.call(null,vec__28959,(0),null);
...
var G__28965 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28966 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28965;
remaining_tokens = G__28966;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28956){
var G__28957 = cljs.core.first.call(null,seq28956);
var seq28956__$1 = cljs.core.next.call(null,seq28956);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28957,seq28956__$1);
});
...
var vec__28970 = cljs.core.split_with.call(null,(function (p1__28969_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28969_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28970,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28970,(1),null);
...
var vec__28973 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28973,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28973,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28976 = cljs.core.rest.call(null,remaining_tokens);
var G__28977 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28976;
name_tokens = G__28977;
continue;
} else {
...
var vec__28980 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28980,(0),null);
var arity = cljs.core.nth.call(null,vec__28980,(1),null);
var vec__28983 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28983,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28983,(1),null);
var vec__28986 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28986,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28986,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28986,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28986,(3),null);
...
var vec__28992 = result;
var munged_ns = cljs.core.nth.call(null,vec__28992,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28992,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28992,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28992,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28992,(4),null);
var arity = cljs.core.nth.call(null,vec__28992,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__28996 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__28996,(0),null);
var args = cljs.core.nth.call(null,vec__28996,(1),null);
var vec__28999 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28999,(0),null);
var name = cljs.core.nth.call(null,vec__28999,(1),null);
...
var G__29002 = (arity + (1));
var G__29003 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29004){
var vec__29005 = p__29004;
var arity = cljs.core.nth.call(null,vec__29005,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__29005,(1),null);
...
return cljs.core.get.call(null,arities,p1__29008_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__29009_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___29016 = arguments.length;
var i__4642__auto___29017 = (0);
while(true){
if((i__4642__auto___29017 < len__4641__auto___29016)){
args__4647__auto__.push((arguments[i__4642__auto___29017]));

var G__29018 = (i__4642__auto___29017 + (1));
i__4642__auto___29017 = G__29018;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29012){
var vec__29013 = p__29012;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__29013,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29010){
var G__29011 = cljs.core.first.call(null,seq29010);
var seq29010__$1 = cljs.core.next.call(null,seq29010);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29011,seq29010__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__29021__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__29021__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__29021__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__29021__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29022 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__29022,(0),null);
var fn_name = cljs.core.nth.call(null,vec__29022,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__29022,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__29022,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__29022,(4),null);
var arity = cljs.core.nth.call(null,vec__29022,(5),null);
...
var o__27872__auto__ = f;
return (o__27872__auto__["getBasis"]).call(o__27872__auto__);
});
/**
...
}catch (e29026){var _e__27879__auto__ = e29026;
...
var G__29027 = (obj[cljs.core.first.call(null,path)]);
var G__29028 = cljs.core.rest.call(null,path);
obj = G__29027;
path = G__29028;
continue;
} else {
...
return (function (accum,p__29029){
var vec__29030 = p__29029;
var bit = cljs.core.nth.call(null,vec__29030,(0),null);
var protocol = cljs.core.nth.call(null,vec__29030,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29033){
var vec__29034 = p__29033;
var ns = cljs.core.nth.call(null,vec__29034,(0),null);
var name = cljs.core.nth.call(null,vec__29034,(1),null);
var selector = cljs.core.nth.call(null,vec__29034,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__29039,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__29039,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__29039,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29037_SHARP_){
return (obj[cljs.core.first.call(null,p1__29037_SHARP_)]);
});})(name,sorted_matches,vec__29039,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1547939634364
