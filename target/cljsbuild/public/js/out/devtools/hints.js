...
}catch (e34352){var _e = e34352;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___34355 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___34355)){
var seen_errors_34356 = temp__5718__auto___34355;
if(cljs.core.truth_(seen_errors_34356.has(self))){
} else {
seen_errors_34356.add(self);

var temp__5720__auto___34357 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___34357)){
var sense_34358 = temp__5720__auto___34357;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_34358)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1547205528691
