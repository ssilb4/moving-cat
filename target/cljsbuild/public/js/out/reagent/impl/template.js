...
var G__38512 = o;
(G__38512[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38513__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38513 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38514__i = 0, G__38514__a = new Array(arguments.length -  0);
while (G__38514__i < G__38514__a.length) {G__38514__a[G__38514__i] = arguments[G__38514__i + 0]; ++G__38514__i;}
  args = new cljs.core.IndexedSeq(G__38514__a,0,null);
} 
return G__38513__delegate.call(this,args);};
G__38513.cljs$lang$maxFixedArity = 0;
G__38513.cljs$lang$applyTo = (function (arglist__38515){
var args = cljs.core.seq(arglist__38515);
return G__38513__delegate(args);
});
G__38513.cljs$core$IFn$_invoke$arity$variadic = G__38513__delegate;
return G__38513;
})()
;
} else {
...
var G__38516 = o;
(G__38516[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__38517__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38517 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38518__i = 0, G__38518__a = new Array(arguments.length -  0);
while (G__38518__i < G__38518__a.length) {G__38518__a[G__38518__i] = arguments[G__38518__i + 0]; ++G__38518__i;}
  args = new cljs.core.IndexedSeq(G__38518__a,0,null);
} 
return G__38517__delegate.call(this,args);};
G__38517.cljs$lang$maxFixedArity = 0;
G__38517.cljs$lang$applyTo = (function (arglist__38519){
var args = cljs.core.seq(arglist__38519);
return G__38517__delegate(args);
});
G__38517.cljs$core$IFn$_invoke$arity$variadic = G__38517__delegate;
return G__38517;
})()
;
} else {
...
var G__38521 = props;
var G__38521__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__38521,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38521);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__38521__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__38522){
...
var props = map__38523__$1;
var class$ = cljs.core.get.call(null,map__38523__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__38523,map__38523__$1,props,class$){
return (function (c){
...
});})(map__38523,map__38523__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__38525){
...
var on_write = cljs.core.get.call(null,map__38526__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__38526,map__38526__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__38526,map__38526__$1,on_write))
);
} else {
...
var G__38529 = jsprops;
(G__38529["defaultValue"] = value);

(G__38529["onChange"] = ((function (G__38529,v,value,on_change){
return (function (p1__38528_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38528_SHARP_);
});})(G__38529,v,value,on_change))
);
...
var vec__38532 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38532,(0),null);
var id = cljs.core.nth.call(null,vec__38532,(1),null);
var class$ = cljs.core.nth.call(null,vec__38532,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___38536 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___38536 == null)){
} else {
var key_38537 = temp__5724__auto___38536;
(jsprops["key"] = key_38537);
}
...
var temp__5724__auto___38538 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___38538 == null)){
} else {
var key_38539 = temp__5724__auto___38538;
reagent.impl.template.oset.call(null,jsprops,"key",key_38539);
}
...
var G__38540 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__38540["name"] = c);
...
var len__4641__auto___38545 = arguments.length;
var i__4642__auto___38546 = (0);
while(true){
if((i__4642__auto___38546 < len__4641__auto___38545)){
args__4647__auto__.push((arguments[i__4642__auto___38546]));

var G__38547 = (i__4642__auto___38546 + (1));
i__4642__auto___38546 = G__38547;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38543){
var G__38544 = cljs.core.first.call(null,seq38543);
var seq38543__$1 = cljs.core.next.call(null,seq38543);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38544,seq38543__$1);
});
...
break;
default:
var G__38550 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__38550;
continue;
...
var n__4518__auto___38552 = a.length;
var i_38553 = (0);
while(true){
if((i_38553 < n__4518__auto___38552)){
(a[i_38553] = reagent.impl.template.as_element.call(null,(a[i_38553])));

var G__38554 = (i_38553 + (1));
i_38553 = G__38554;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___38555 = a.length;
var i_38556 = (0);
while(true){
if((i_38556 < n__4518__auto___38555)){
var val_38557 = (a[i_38556]);
if(((cljs.core.vector_QMARK_.call(null,val_38557)) && ((reagent.impl.template.key_from_vec.call(null,val_38557) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_38556] = reagent.impl.template.as_element.call(null,val_38557));

var G__38558 = (i_38556 + (1));
i_38556 = G__38558;
continue;
} else {
}
...
var ctx = ({});
var vec__38559 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38559,(0),null);
var derefed = cljs.core.nth.call(null,vec__38559,(1),null);
...
var G__38562 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38562) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__38562){
...
//# sourceMappingURL=template.js.map?rel=1547939644039
