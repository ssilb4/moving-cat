...
var G__33546 = o;
(G__33546[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__33548__i < G__33548__a.length) {G__33548__a[G__33548__i] = arguments[G__33548__i + 0]; ++G__33548__i;}
  args = new cljs.core.IndexedSeq(G__33548__a,0,null);
} 
...
var args = cljs.core.seq(arglist__33549);
...
var G__33550 = o;
(G__33550[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__33555 = props;
var G__33555__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__33555,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__33555);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__33555__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__33556){
var map__33557 = p__33556;
var map__33557__$1 = (((((!((map__33557 == null))))?(((((map__33557.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33557.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33557):map__33557);
var props = map__33557__$1;
var class$ = cljs.core.get.call(null,map__33557__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__33557,map__33557__$1,props,class$){
return (function (c){
...
});})(map__33557,map__33557__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__33559){
...
var on_write = cljs.core.get.call(null,map__33560__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__33560,map__33560__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__33560,map__33560__$1,on_write))
);
} else {
...
var G__33563 = jsprops;
(G__33563["defaultValue"] = value);

(G__33563["onChange"] = ((function (G__33563,v,value,on_change){
return (function (p1__33562_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__33562_SHARP_);
});})(G__33563,v,value,on_change))
);
...
var vec__33566 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__33566,(0),null);
var id = cljs.core.nth.call(null,vec__33566,(1),null);
var class$ = cljs.core.nth.call(null,vec__33566,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___33570 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___33570 == null)){
} else {
var key_33571 = temp__5724__auto___33570;
(jsprops["key"] = key_33571);
}
...
var temp__5724__auto___33572 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___33572 == null)){
} else {
var key_33573 = temp__5724__auto___33572;
reagent.impl.template.oset.call(null,jsprops,"key",key_33573);
}
...
var G__33574 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__33574["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq33577){
var G__33578 = cljs.core.first.call(null,seq33577);
var seq33577__$1 = cljs.core.next.call(null,seq33577);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33578,seq33577__$1);
});
...
break;
default:
var G__33584 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__33584;
continue;
...
var n__4518__auto___33586 = a.length;
var i_33587 = (0);
while(true){
if((i_33587 < n__4518__auto___33586)){
(a[i_33587] = reagent.impl.template.as_element.call(null,(a[i_33587])));

var G__33588 = (i_33587 + (1));
i_33587 = G__33588;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___33589 = a.length;
var i_33590 = (0);
while(true){
if((i_33590 < n__4518__auto___33589)){
var val_33591 = (a[i_33590]);
if(((cljs.core.vector_QMARK_.call(null,val_33591)) && ((reagent.impl.template.key_from_vec.call(null,val_33591) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_33590] = reagent.impl.template.as_element.call(null,val_33591));

var G__33592 = (i_33590 + (1));
i_33590 = G__33592;
continue;
} else {
}
...
var ctx = ({});
var vec__33593 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__33593,(0),null);
var derefed = cljs.core.nth.call(null,vec__33593,(1),null);
...
var G__33596 = (cljs.core.count.call(null,argv) - first_child);
switch (G__33596) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__33596){
...
//# sourceMappingURL=template.js.map?rel=1547205527453
